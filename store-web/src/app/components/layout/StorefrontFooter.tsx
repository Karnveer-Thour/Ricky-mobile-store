...
export default function StorefrontFooter() {
  return (
    <>
      <footer
        className="border-t border-white/5 px-4 sm:px-6 pt-12 pb-24 mt-8 bg-[#0e0e1c]/40"
        role="contentinfo"
      >
        <div className="max-w-7xl mx-auto grid sm:grid-cols-2 lg:grid-cols-5 gap-8 mb-10">
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              <div className="w-8 h-8 rounded-xl bg-[#00cfff] flex items-center justify-center shadow-lg shadow-[#00cfff]/20">
        ...
        <div className="max-w-7xl mx-auto pt-6 border-t border-white/5 flex flex-wrap justify-between items-center gap-3 text-xs text-gray-500">
          <p className="text-gray-400">
            Khanna Showroom &amp; Service Hub &bull; Ludhiana District, Punjab
          </p>
      ...
      {/* Fixed bottom footer bar across main website */}
      <aside
        className="fixed bottom-0 inset-x-0 z-40 bg-[#07070f]/92 backdrop-blur-xl border-t border-white/10 shadow-[0_-8px_30px_rgba(0,0,0,0.7)] py-2 px-4 sm:px-6 transition-all duration-300"
        aria-label="Official Store Footer and Copyright Bar"
      >
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-3 text-xs">
          <GlobalCopyright />
          <div className="hidden sm:flex items-center gap-2.5 text-[11px] text-gray-400 font-mono">
            ...
            <span className="text-gray-400">Khanna &amp; Ludhiana</span>
          </div>
        </div>
      </aside>
    </>
