...
const accentMap = {
  cyan: {
    ...
    iconBg: "bg-cyan-50 text-cyan-600 border border-cyan-200/80 dark:bg-cyan-500/15 dark:text-cyan-400 dark:border-transparent",
  ...
  blue: {
    ...
    iconBg: "bg-blue-50 text-blue-600 border border-blue-200/80 dark:bg-blue-500/15 dark:text-blue-400 dark:border-transparent",
  ...
  purple: {
    gradient: "from-purple-600 to-pink-600 dark:from-purple-400 dark:to-pink-500",
    iconBg: "bg-purple-50 text-purple-600 border border-purple-200/80 dark:bg-purple-500/15 dark:text-purple-400 dark:border-transparent",
  ...
  emerald: {
    gradient: "from-emerald-600 to-teal-600 dark:from-emerald-400 dark:to-teal-500",
    iconBg: "bg-emerald-50 text-emerald-600 border border-emerald-200/80 dark:bg-emerald-500/15 dark:text-emerald-400 dark:border-transparent",
