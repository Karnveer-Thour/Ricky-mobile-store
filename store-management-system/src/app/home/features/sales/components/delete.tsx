  ...
  return (
    <BlurredPopupLayout width={"400px"} height={"auto"} isDark={isDark}>
      <div className="p-2 text-center space-y-4">
        <h2 className={`text-xl font-bold ${isDark ? "text-white" : "text-slate-900"}`}>Cancel / Delete Order</h2>
        <p className="text-sm font-medium text-rose-500">
          Are you sure you want to remove order record <span className="font-bold">{Name}</span> (#{Id})?
        </p>
