...
import { Edit3, Check, X, Palette, Sliders } from "lucide-react";
    ...
    if (typeof window !== "undefined") {
      ...
      if (stored) {
        try {
          ...
          setHasColors(parsed.hasColors !== undefined ? Boolean(parsed.hasColors) : true);
          setHasVariants(parsed.hasVariants !== undefined ? Boolean(parsed.hasVariants) : false);
        } catch (e) {
