  ...
  return (
    <BlurredPopupLayout width={"60%"} height={"auto"} isDark={isDark}>
      <div className="w-full flex items-center gap-3 border-b border-white/10 pb-4 mb-4">
        ...
        <div>
          <h2 className="text-xl font-extrabold text-white">Update WhatsApp Group</h2>
          <p className="text-xs text-slate-400">Modify group link and active broadcasting status</p>
        </div>
      </div>
