...
function addProduct() {
  ...
  return (
    <BlurredPopupLayout width={"60%"} height={"auto"}>
      ...
      <form action="" className="flex-1 w-full p-3">
        <Inputcontainer type={"Name"} error={errors?.name}>
          <Input
            ...
            {...register("name")}
            className="border-2 border-gray-500 font-bold"
          />
        </Inputcontainer>
        <div className="flex items-center justify-between w-full">
          <Inputcontainer type={"Category"} error={errors?.category}>
            <Select className="w-full border-2 text-gray-500">
        ...
        <Inputcontainer type={"Price"} error={errors?.price}>
          <Input
            id="Price"
        ...
        <Inputcontainer type={"Discount"} error={errors?.discount}>
          <Input
            id="discount"
        ...
        <Inputcontainer type={"Color"} error={errors?.color}>
          <div className="w-full flex justify-between items-center flex-wrap">
            {colorCount.map((count) => (
              <div key={count} className="w-[48%] flex justify-between">
                <div className="w-[60%]">
                  <Inputcontainer type={"Color Name"} error={errors?.colorName}>
                    <Input
                      id="ColorName"
