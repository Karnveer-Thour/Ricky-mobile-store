      ...
      if (stored) {
        try {
          ...
          if (
            ...
            setDirectQuantity(currentQty);
            setColorVariants([{ name: "Standard", quantity: currentQty }]);
          }

          // Initialize product variants if present
          if (
            parsed.variants &&
